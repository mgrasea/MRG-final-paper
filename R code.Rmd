...
```{r}
data <- read.table("bayes_fst_peacock.txt", header = TRUE, sep = "", stringsAsFactors = FALSE)
```
...
plot(components$Comp.1, components$Comp.2, xlab = "PC 1 - 27.33%",
     ylab= "PC 2 - 25.75%")
...
plot(components$Comp.1, components$Comp.2, xlab = "PC 1 - 20.25%",
     ylab= "PC 2 - 20.23%")
